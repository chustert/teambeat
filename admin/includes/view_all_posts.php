    ...
    foreach ($_POST['checkBoxArray'] as $postValue_id) {
        ...
        switch ($bulk_options) {
            case 'published':
                ...
                $query .= "WHERE post_id = '{$postValue_id}' ";
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            while($row = mysqli_fetch_assoc($select_posts)) {
                ...
                echo "<td><img src='../images/{$post_image}' width='100' alt=''</td>";
...
if(isset($_GET['reset'])) {
        ...
        $query = "UPDATE posts SET post_views_count = 0 WHERE post_id =" . mysqli_real_escape_string($connection, $_GET['reset']) . " "; // Here we escape the_post_id with the mysqli function --> BETTER!
